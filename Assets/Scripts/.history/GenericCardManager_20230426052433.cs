...
public class GenericCardManager : MonoBehaviour
{
	...
	public void SlideOutToBottom(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public void SlideOutToTop(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public void SlideOutToLeft(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public void SlideOutToRight(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
