...
public class GenericCardManager : MonoBehaviour
{
    ...
    public GenericCard SpawnCardFromLeft(float xratio, float yratio ,int face, int tail)
    {
	...
	public GenericCard SpawnCardFromRight(float xratio, float yratio ,int face, int tail)
    {
        GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public GenericCard SpawnCardFromTop(float xratio, float yratio ,int face, int tail)
    {
        GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public GenericCard SpawnCardFromBottom(float xratio, float yratio ,int face, int tail)
    {
        GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public GenericCard SlideOutToBottom(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
        ...
        float cardWidth = cardObject.GetComponent<SpriteRenderer>().bounds.size.x;
        float cardHeight = cardObject.GetComponent<SpriteRenderer>().bounds.size.y;
		float xPosition = go.transform.x;
        float yPosition = -(screenHeight / 2) - (cardHeight / 2);
		Vector3 slideOutPosition = new Vector3(xPosition, yPosition, 0f);

        StartCoroutine(SlideIn(go.transform, slideOutPosition, duraiton));
		return cardObject;
	}
	public GenericCard SlideOutToTop(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
	...
	public GenericCard SlideOutToLeft(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
        ...
        float cardHeight = cardObject.GetComponent<SpriteRenderer>().bounds.size.y;
        float xPosition = -(screenWidth / 2) - (cardWidth / 2);
		float yPosition = go.transform.y;
		Vector3 slideOutPosition = new Vector3(xPosition, yPosition, 0f);

        StartCoroutine(SlideIn(go.transform, slideOutPosition, duraiton));
		return cardObject;
	}
	public GenericCard SlideOutToRight(GameObject go, float duration){
		GameObject cardObject = Instantiate(genericCardPrefab);
        GenericCard card = cardObject.GetComponent<GenericCard>();
