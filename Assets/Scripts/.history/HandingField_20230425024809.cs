...
public class HandingField : MonoBehaviour
{
    ...
    // ターンごとの提出値を保持するList
    private List<Dictionary<string,int>> HandedScores;
	...
	public void StartTurn()
	{
        ...
        HandedScores = new List<Dictionary<string, int>>();
	...
	public void SubmitCard(GameObject cardObject, string uid)
	{
        ...
        HandedScores.Add(new Dictionary<string, int>(uid, cardObject.GetComponent<GenericCard>().cardIndex%13+1));
		int currentScore = playerScores[uid];
		int cardValue = cardObject.GetComponent<GenericCard>().cardIndex%13+1;
